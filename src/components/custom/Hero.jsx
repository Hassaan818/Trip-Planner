  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-[#462F26]">
            ...
            <br />
            <i style={{ fontFamily: "Monotype Corsiva, cursive" }}>
        ...
        >
          Seamlessly crafted itineraries that bring your travel aspirations to
          life
        </p>
      </div>
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <Link to="/about">
          <Button
            className="bg-white text-[#462F26] border border-[#462F26] rounded hover:bg-[#462F26] hover:text-white hover:border-[#805545]"
            style={{
              transition: "all 0.2s",
              fontWeight: "600",
            }}
